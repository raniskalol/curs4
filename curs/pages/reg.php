     ...
     <section class="a2">
        ...
        <div class="login-page">
            <div class="form">
              ...
              <form action="action/reg.php" method="post" class="login-form">
              <?php
            ...
            ?>
                ...
                <?php
            if (isset($_SESSION['error']['passwordr'])) {
                ?>
                <p style="color: red"><?= $_SESSION['error']['passwordr'] ?></p>
                <?php
                unset($_SESSION['error']['passwordr']);
            }
            ?>
                <input type="password" name="passwordr" placeholder="Повторите пароль"/>
                <button type="submit" class="btt">Зарегистрироваться</button>
                <p class="message">Уже зарегистрированы? <a href="?page=auth ">Войти</a></p>
              </form>
            </div>
          </div>
